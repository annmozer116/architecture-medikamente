...
![Диаграмма Исикавы](Task4/fish-bone.drawio.png)
...
- **Данные:** провести инвентаризацию и очистку данных перед миграцией; описать жизненный цикл данных и политики хранения/удаления; определить модель категорий и тегов до старта миграции; спроектировать партиционирование и архивацию для растущего объёма; внедрить IAM, тегирование, маскирование, аудит доступа и подсистему согласий
